...
export const MEET_LINK = process.env.WORKSHOP_MEET_LINK || 'https://meet.google.com/tsg-arac-krg';
...
export const WORKSHOP_DURATION_MINUTES = Number(process.env.WORKSHOP_DURATION_MINUTES || 60);
