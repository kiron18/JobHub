...
// Removed 2026-07-19: dimensional job-scoring is intentionally not used in the
// product (hard match scores are unhelpful for graduates). Tests deleted so the
// suite reflects live behaviour rather than a shelved feature.
