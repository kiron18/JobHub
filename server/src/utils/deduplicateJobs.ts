...
/**
 * Merges scraped (Seek/LinkedIn, preferred) and Adzuna jobs, deduplicating
 * by exact URL then by fuzzy title+company+location.
 */
export function deduplicateJobs(scrapedJobs: RawJob[], adzunaJobs: RawJob[]): RawJob[] {
