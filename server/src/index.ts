...
import answerBankRouter from './routes/answer-bank';
...
import adminWorkshopRouter from './routes/admin-workshop';
import adminIngestionRouter from './routes/admin-ingestion';
...
app.use('/api/answer-bank', answerBankRouter);
...
app.use('/api/admin/coach', coachRouter);
app.use('/api/admin', adminRouter);
app.use('/api/admin/funnel', adminFunnelRouter);
app.use('/api/admin/sales', adminSalesRouter);
app.use('/api/admin/workshop', adminWorkshopRouter);
app.use('/api/admin/ingestion', adminIngestionRouter);
