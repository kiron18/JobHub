        ...
        <div className="glass-card p-1">
            ...
            <button
                ...
                className={`w-full p-8 border-2 border-dashed rounded-2xl flex flex-col items-center justify-center gap-4 transition-all
                    ${isUploading ? 'border-brand-500/20 bg-brand-500/5' : 'border-[rgba(26,24,20,0.16)] hover:border-brand-500/50 hover:bg-brand-500/5 cursor-pointer'}
            ...
            >
                {isUploading ? (
                    <>
                        ...
                        <p className="font-bold text-[#1A1814]">Uploading Document...</p>
                    </>
                ) : success ? (
                    <>
                    ...
                    <>
                        <div className="w-12 h-12 bg-[#F4EFE8] rounded-xl flex items-center justify-center text-[#5C5750]">
                            <Upload size={24} />
                        </div>
                        <div className="text-center">
                            <p className="font-bold text-[#1A1814]">Click to upload source document</p>
                            <p className="text-sm text-[#8B847B] mt-1">Supports TXT, MD, PDF (text extraction coming soon)</p>
                        </div>
                    </>
                )}
            </button>
